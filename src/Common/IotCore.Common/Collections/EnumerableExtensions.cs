...
using System.Linq;
using System.Text;
using IotCore.Common.Extensions;
using IotCore.Common.Filter;

namespace IotCore.Common.Collections
{
    /// <summary>
    /// Enumerable集合扩展方法
    /// </summary>
    public static class EnumerableExtensions
    {
        ...
        {
            return collection.ExpandAndToString(t => t?.ToString() ?? string.Empty, separator);
        }
